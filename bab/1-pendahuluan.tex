...
% yang nantinya dapat diterapkan pada alat \textit{Smart Whiteboard.}
...
% \begin{enumerate}[nolistsep]
%     \item Membuat program komputer yang dapat melakukan deteksi teks huruf balok pada papan tulis.
%     % sehingga dapat diimplementasikan pada alat \textit{Smart Whiteboard.}
% \end{enumerate}
