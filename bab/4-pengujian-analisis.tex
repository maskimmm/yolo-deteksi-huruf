...
\subsubsection{Hasil \textit{Image Transformation}}
...
\begin{enumerate}[nolistsep]
  ...
  % Pada model \textit{safety helmet} variasi objeknya yaitu untuk kelas \textit{"helmet"} yaitu kepala orang dengan menggunakan helm keselamatan dan untuk kelas "alarm" yaitu kepala orang yang tidak menggunakan helm keselamatan. Sedangkan pada model huruf balok memiliki variasi objek yaitu sebanyak 30 kelas objek. 
