...
% //FIXME: perbarui tabel, tambahkan proses validation
\begin{figure}[H]
    \centering
...
% //FIXME: ganti gambar ke terbaru
% blok proses labelling diganti menjadi proses pelabelan, blok image preprocess gapake dalam kurung
\begin{figure}[ht]
    \centering
...
% //TODO: pertimbangkan penggunaan noise, blur, bbrotation
\begin{enumerate}[nolistsep]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[scale=0.05]{gambar/null_image.jpg}
    ...
    % //TODO: tambahin gambar before after grayscale
...
% //FIXME: ganti flowchart pembuatan  
\begin{figure}[!ht]
    \centering
